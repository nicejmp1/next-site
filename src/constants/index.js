...
export const skillText = [
    {
        title: "꿈을 설계하고 디자인 한다.",
        desc: "저는 프론트엔드 개발자로서, 사용자의 요구와 기대를 반영한 인터페이스를 설계하고 구현하는 데 중점을 둡니다. 웹사이트와 애플리케이션의 디자인은 단순히 미적인 요소를 넘어, 사용자 경험을 극대화하는 중요한 역할을 합니다. 저는 최신 웹 기술과 트렌드를 활용하여 직관적이고 반응형인 UI를 만들고, 이를 통해 사용자가 쉽고 편리하게 웹을 탐색할 수 있도록 합니다. 이러한 과정을 통해 꿈을 현실로 만들어가는 여정을 계속하고 있습니다",
    },
    {
        title: "끊임없는 학습과 성장",
        desc: "프론트엔드 개발자로서 성공하기 위해서는 끊임없는 학습과 성장이 필수적입니다. 저는 새로운 기술과 도구를 배우고 적용하는 것을 즐기며, 항상 최신 트렌드와 베스트 프랙티스를 따라가려고 노력합니다. 이를 통해 보다 효율적이고 효과적인 코드를 작성할 수 있으며, 복잡한 문제를 해결하고 창의적인 솔루션을 제시할 수 있습니다. 이러한 지속적인 학습과 성장은 저를 더욱 능력 있는 개발자로 만들어줍니다",
    },
    {
        title: "협업과 소통의 중요성",
        desc: "프론트엔드 개발자는 디자이너, 백엔드 개발자, 프로젝트 매니저 등 다양한 팀원들과 협력해야 합니다. 저는 효과적인 소통과 협업을 통해 프로젝트의 성공을 도모합니다. 명확한 의사소통은 문제 해결과 아이디어 구현에 있어 필수적이며, 팀의 목표 달성에 큰 기여를 합니다. 또한, 코드 리뷰와 피드백을 통해 서로의 역량을 향상시키고, 보다 나은 결과물을 만들어내는 것을 목표로 합니다.",
    },
]

export const siteText = [
    {
        text: ["PHP를", "이용하여 마라톤 대회일정", "사이트 제작"],
        title: "PHP 이용한 사이트 제작",
        code: "https://github.com/nicejmp1/Way-Run-Meaning",
        view: "http://nicejmp.dothome.co.kr",
        info: [
            "site coding",
            "Project D-Day : 2024.04.01 ~ 2024.06.12",
            "기술스택 : HTML5/CSS3, PHP, javascript",
        ],
    },
    {
        text: ["make", "site compliant with", "react.js"],
        title: "리액트를 이용한 치킨 사이트 제작",
        code: "https://github.com/nicejmp1/chiken",
        view: "#",
        info: [
            "site coding",
            "Project D-Day : 2024.06.01 ~ ing",
            "기술스택 : react.js, scss, javascript",
        ],
    },
    {
        text: ["make", "site compliant with", "vue.js"],
        title: "뷰를 이용한 포트폴리오 사이트 제작",
        code: "https://github.com/nicejmp1/vue-site",
        view: "#",
        info: [
            "site coding",
            "Project D-Day : 2024.06.10 ~ img ",
            "기술스택 : HTML5/CSS3, Scss Variable, vue",
        ],
    },
    {
        ...
        info: [
            ...
            "기술스택 : HTML5/CSS3, Scss Variable, next.js",
        ],
    },
];
...
export const contactText = [
    ...
    {
        link: "mailto:nicejpm@naver.com",
        title: "mail : nicejpm@naver.com",
    },
];
